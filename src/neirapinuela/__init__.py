    ...
    if (
        ...
        error_details = {
            ...
            403: {
                ...
                "description": gettext(
                    "You don't have permission to access this resource. This application is restricted to specific family members."
                ),
            ...
            500: {
                ...
                "description": gettext(
                    "Our server encountered an unexpected error while processing your request. The issue has been logged and our team will investigate it."
                ),
            ...
            503: {
                ...
                "description": gettext(
                    "The server is temporarily unable to handle your request due to maintenance or capacity issues. Please try again later."
                ),
                "suggestion": gettext("Refresh"),
            },
            504: {
